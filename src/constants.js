export const clues = [
	{
		...
		clueInput: '',
		validInput: ['', '2', '3', '5'],
		errCheck: function(numberToGuess, clueInput) {return numberToGuess % clueInput !== 0;},
		verifyCheck: function(workNumberList, clueInput) {return workNumberList % clueInput !== 0;},
	},
	{
		id: '2',
